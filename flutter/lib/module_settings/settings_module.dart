...
class SettingsModule extends YesModule {
  ...
  final RenewSubscriptionScreen _subscriptionScreen;
  SettingsModule(this._settingsScreen,this._subscriptionScreen) {
    YesModule.RoutesMap.addAll({
      SettingRoutes.ROUTE_SETTINGS: (context) => _settingsScreen,
      SettingRoutes.RENEW_SUBSCRIPTION :(context) => _subscriptionScreen
    });
  }
}