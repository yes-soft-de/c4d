...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "orderAverage80" : MessageLookupByLibrary.simpleMessage("تذكير ثاني لسدادالدفعة الأخيرة من رسوم الباقة لتفادي انقطاع الخدمة . حيث أنه تم استهلاك 80% من رصيد الباقة وشكرا"),
    ...
    "whatsappWithClient" : MessageLookupByLibrary.simpleMessage("واتساب مع الزبون"),
    "whatsappWithStoreOwner" : MessageLookupByLibrary.simpleMessage("واتساب مع المتجر"),
