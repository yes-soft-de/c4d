...
class OrderStatusForCaptainScreen extends StatefulWidget {
  ...
  @override
  _OrderStatusForCaptainScreenState createState() =>
      _OrderStatusForCaptainScreenState();
}

class _OrderStatusForCaptainScreenState
    extends State<OrderStatusForCaptainScreen> {
  OrderModel order;
